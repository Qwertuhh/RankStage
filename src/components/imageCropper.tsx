...
export default function CropperComponent({ onCropped, onRemove }: CropperComponentProps = {}) {
  const [
    { files, isDragging },
    {
      handleDragEnter,
  ...
  const handleApply = async () => {
    ...
    try {
      ...
      // 2b. Create a File from blob to pass back to parent/forms
      ...
      // 4b. Emit to parent for form integration
      if (onCropped) {
        onCropped(croppedFile, newFinalUrl)
      }
